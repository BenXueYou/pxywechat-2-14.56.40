...
;(function ($, window, document) {
            ...
            this.intvFunc = setInterval(function () {
                ...
                if ((!back && counter >= val) || (back && counter <= val)) {
                    if (self.current_value == counter) {
                        ...
                        counter = 0;//这里有修改，定死counter，则会循环。
                    }
                }
    ...
    //radial indicator defaults径向指示器初始化
    radialIndicator.defaults = {
        ...
        frameTime: 100, //miliseconds to move from one frame to another
        ...
        displayNumber: false, //display indicator number
